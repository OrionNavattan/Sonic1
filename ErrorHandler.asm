...
Str_ErrorHeader:
   dc.b   pal3,"A serious error has occurred.",endl

   dc.b	  "Please send the following error report",endl

   dc.b   "to ",pal2,"orionburd@gmail.com",pal3,".",pal1,endl,endl
   dc.b 0
   even

BusError:
	__ErrorMessage "%<.l #Str_ErrorHeader str>BUS ERROR", _eh_default|_eh_address_error|_eh_disassemble

AddressError:
	__ErrorMessage "%<.l #Str_ErrorHeader str>ADDRESS ERROR", _eh_default|_eh_address_error|_eh_disassemble

IllegalInstr:
	__ErrorMessage "%<.l #Str_ErrorHeader str>ILLEGAL INSTRUCTION", _eh_default|_eh_disassemble

ZeroDivide:
	__ErrorMessage "%<.l #Str_ErrorHeader str>DIVIDE BY ZERO", _eh_default|_eh_disassemble

ChkInstr:
	__ErrorMessage "%<.l #Str_ErrorHeader str>CHK INSTRUCTION", _eh_default|_eh_disassemble

TrapvInstr:
	__ErrorMessage "%<.l #Str_ErrorHeader str>TRAPV INSTRUCTION", _eh_default|_eh_disassemble

PrivilegeViol:
	__ErrorMessage "%<.l #Str_ErrorHeader str>PRIVILEGE VIOLATION", _eh_default|_eh_disassemble

Trace:
	__ErrorMessage "%<.l #Str_ErrorHeader str>TRACE", _eh_default|_eh_disassemble

Line1010Emu:
	__ErrorMessage "%<.l #Str_ErrorHeader str>LINE A EMULATOR", _eh_default|_eh_disassemble

Line1111Emu:
	__ErrorMessage "%<.l #Str_ErrorHeader str>LINE F EMULATOR", _eh_default|_eh_disassemble

ErrorExcept:
	__ErrorMessage "%<.l #Str_ErrorHeader str>ERROR EXCEPTION", _eh_default|_eh_disassemble
