...
UCX_BehindMid:
	...
	; a scripted event that moves the camera away from and then back to the player character.
	; The following adds the missing limits on leftward movement of the camera.
		cmpi.w	#$FFF0,d0				; has the screen moved more than 10 pixels left?
		bcc.s	Behind_NoMax				; if not, branch
