...
;		jsr	BGHZ_ShipIndex(pc,d1.w)
		...
		; to Sonic 2 or 3, this will cause a crash due to the lack of a valid sprite mappings pointer.
BGHZ_ShipDisplay:
		lea	(Ani_Bosses).l,a1
		jsr	(AnimateSprite).l
...
;		rts	
	...
	; Optimized with code backported from Sonic 3.
		...
		ext.l	d0
		lsl.l	#8,d0
		add.l	d0,ost_boss_parent_x_pos(a0)
		move.w	ost_y_vel(a0),d0
		ext.l	d0
		lsl.l	#8,d0
...
BGHZ_Explode:	; Ship Routine 8
		...
		bra.w	BGHZ_ShipDisplay		; Added line
; ===========================================================================
